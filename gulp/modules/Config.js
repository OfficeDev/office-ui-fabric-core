...
var Config = function () {
  ...
  this.paths.distSampleComponents =
    this.paths.dist + "/samples/" + "/Components";
  ...
  this.paths.srcDocTemplateModulesComponents =
    this.paths.srcDocTemplateModules + "/components";

  this.port = process.env.PORT || 2020;
  this.projectURL = "http://localhost";
  this.projectDirectory = path.resolve(
    __dirname,
    "../../" + this.paths.distDocumentation
  );
  this.servePaths = [
    {
      urlPath: "/css",
  ...
  this.nugetConfig = {
    ...
    licenseUrl:
      "https://github.com/OfficeDev/Office-UI-Fabric-Core/blob/master/LICENSE",
  ...
  this.componentSamplesFinished =
    " Component Samples build was successful! Yay!";
  ...
  //Errors
  this.genericBuildError =
    "Hmm, something went wrong in the build... Here is the error dump";
  this.templateLibraryConfig = {
    components: ["ContextualHost", "Button"],
  };
};
