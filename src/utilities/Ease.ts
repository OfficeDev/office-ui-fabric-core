...
namespace fabric {
  export class Ease {
    ...
    public static BACK_EASE_OUT: string =
      Ease.CB + "(0.175, 0.885, 0.320, 1.275)";

    public static QUAD_EASE_IN_OUT: string =
      Ease.CB + "(0.455, 0.030, 0.515, 0.955)";
    public static CUBIC_EASE_IN_OUT: string =
      Ease.CB + "(0.645, 0.045, 0.355, 1)";
